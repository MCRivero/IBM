...
# isdigit(): Devuelve un boolean, nos dice si el valor introducido es un string. Tiene que ser un valor introducido 
# entre comillas o dará error.
s_texto6 = "6"
print(s_texto6.isdigit())

# isalum(): Devuelve un boolean. Devuelve verdadero si todos los caracteres de la cadena son numéricos y hay al menos un carácter. 
